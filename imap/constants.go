...
const (
	...
	IMAP_SESSION_STATE_MAIL
	IMAP_SESSION_STATE_RCPT
	IMAP_SESSION_STATE_DATA
	IMAP_SESSION_STATE_SUBMIT
...
func (s ImapSessionState) String() string {
	...
	case IMAP_SESSION_STATE_MAIL:
		return "SESSION_STATE_MAIL"
	case IMAP_SESSION_STATE_RCPT:
		return "SESSION_STATE_RCPT"
	case IMAP_SESSION_STATE_DATA:
		return "SESSION_STATE_DATA"
	case IMAP_SESSION_STATE_SUBMIT:
